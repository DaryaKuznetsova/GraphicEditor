...
namespace DiagramDesigner.ViewModels
{
    ...
    public abstract class SelectedItemViewModelBase : INPCBase, ISelectItems
    {
        private bool isSelected;

        public SelectedItemViewModelBase(int id, IDiagramViewModel parent)
        {
            this.Id = id;
            this.Parent = parent;
            Init();
        ...
        public SelectedItemViewModelBase()
        {
            Init();
        }
